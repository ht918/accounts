...
$(document).ready(function(){
	...
	if(!empty($this->request->data)){
		echo '$("#ItemDeptId").val('.$this->request->data['Item']['dept_id'].');';
		unset($this->request->data['Item']['item']);
	}
	?>
	$("#ItemBigId").append(bigdatas[$("#ItemDeptId").val()]);
	<?php
	if(!empty($this->request->data)){
		echo '$("#ItemBigId").val('.$this->request->data['Item']['big_id'].');';
	}
	?>
	$("#ItemSmallId").append(smalldatas[$("#ItemBigId").val()]);
	<?php
	if(!empty($this->request->data)){
		echo '$("#ItemSmallId").val('.$this->request->data['Item']['small_id'].');';
	}
	?>
});
</script>
