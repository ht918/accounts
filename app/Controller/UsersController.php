...
if($_SERVER['DOCUMENT_ROOT'] === 'C:/xampp/htdocs'){
	define('client_id' , "6452672906-2nupd6svirl415omt13ouqcphnr3cn8a.apps.googleusercontent.com");
	define('redirect_uri' , "http://localhost/Accounts/users/oauth_callback");
	define('auth_url' , 'https://accounts.google.com/o/oauth2/auth');
	define('client_secret' , "j2tt7oY1xqSuwxV_F38bgdGS");
...
class UsersController extends AppController {
	...
	public function changeYear(){
		if($this->request->is('post')){
			$year = $this->request->data['User']['change']['year'];
			if(!empty($year)){
				$envstr = "ACNT_SYS_YEAR=".$year;
				putenv($envstr);
			}
		}
